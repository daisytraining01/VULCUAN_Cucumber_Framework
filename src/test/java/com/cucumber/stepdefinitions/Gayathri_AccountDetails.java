...
public class Gayathri_AccountDetails {
	...
	public  Gayathri_AccountDetails (UserActions User) {
		this.User = User;
	}
...
public void the_user_enters_the_pin(String string) {
	User.SendKeys(By.name("accpin"),string);     
...
public void the_Account_Details_link_is_clicked() throws InterruptedException {
